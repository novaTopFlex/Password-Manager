...
def changeMasterPassword(newPassword):
    if newPassword.isspace():
        return "your new Master Password can't have spaces!"
    elif newPassword == "":
        return "your new Master Password can't be blank!"
    else:
        with open('masterpass.pass', 'w') as masterpass:
            masterpass.write(newPassword)
        encrypt('masterpass.pass')
        return "your Master Password has been changed!"
